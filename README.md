...
The agent follows these steps during training:
...
Updates the neural network using sampled mini-batches
Periodically updates the target network
Gradually reduces exploration using epsilon decay

Example output during training:

Episode: 10 Reward: 120.5 Loss: 0.0231 Epsilon: 0.87

The program also generates plots showing:
